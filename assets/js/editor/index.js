 ...
 *
 * @returns {?Element} The sidebar panel, or null for posts that are not
 * attributed to a GitHub release.
 */
function ReleaseAttribution() {
	...
	function handleRegenerate() {
		...
		apiFetch( {
			...
			.then( ( response ) => {
				...
				if ( response && response.post ) {
					...
					wp.data
						...
						.createSuccessNotice(
							__(
								'Post content regenerated from release.',
			...
			.catch( ( error ) => {
				setIsRegenerating( false );
				setResultMessage(
					error.message || __( 'Regeneration failed.', 'auto-release-posts-for-github' ),
				);
			} );
	}
	...
	return (
		<PluginDocumentSettingPanel
			...
			title={ __( 'GitHub Release', 'auto-release-posts-for-github' ) }
			className="ghrp-release-attribution"
		>
			<p style={ { margin: '0 0 8px' } }>
				{ __( 'Generated from', 'auto-release-posts-for-github' ) }{ ' ' }
			...
			{ ! showFeedback && (
				...
				>
					{ __( 'Regenerate', 'auto-release-posts-for-github' ) }
				</Button>
			) }
			...
			{ showFeedback && (
				<div style={ { marginTop: '8px' } }>
					<TextareaControl
						label={ __( 'Feedback (optional)', 'auto-release-posts-for-github' ) }
						help={ __(
							'Tell the AI what to change, e.g. "make it shorter" or "emphasize the security fix".',
							'auto-release-posts-for-github',
						) }
						value={ feedback }
					...
					<div style={ { display: 'flex', gap: '8px', alignItems: 'center' } }>
						...
						>
							{ isRegenerating
								? __( 'Regenerating…', 'auto-release-posts-for-github' )
								: __( 'Regenerate content', 'auto-release-posts-for-github' ) }
						</Button>
						{ ! isRegenerating && (
							<Button
								variant="tertiary"
							...
							>
								{ __( 'Cancel', 'auto-release-posts-for-github' ) }
							</Button>
						) }
